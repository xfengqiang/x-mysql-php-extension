...
#define air_call_static_method(obj_ce, function_name, retval_ptr, param_count, params) air_call_method(NULL, obj_ce, NULL, function_name, strlen(function_name), retval_ptr, param_count, params)
